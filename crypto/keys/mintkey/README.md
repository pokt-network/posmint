...
```bash
go test -v --bench github.com/pokt-network/posmint/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/pokt-network/posmint/crypto/keys/mintkey
...
PASS
ok  	github.com/pokt-network/posmint/crypto/keys/mintkey	12.093s
```
