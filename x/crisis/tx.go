...
func (am AppModule) InvariantBroken(cdc *codec.Codec, moduleName, route string, txBuilder auth.TxBuilder, address sdk.ValAddress, passphrase string) (*sdk.TxResponse, error) {
