...
func (k Keeper) GetDAOPool(ctx sdk.Ctx) (stakedPool exported.ModuleAccountI) {
...
func (k Keeper) coinsFromDAOToValidator(ctx sdk.Ctx, validator types.Validator, amount sdk.Int) {
